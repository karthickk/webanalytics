(function () {
    ...
    function ra() {
    	var f = n.round(2147483647 * n.random());
    	console.log("ssa",f);
        return f
    }
    function Ca(a) {
    ...
    var ab = function (a, b, c, d) {
        ...
        db = function () {};
    var Rc;
    if (Rc = qa(window.GoogleAnalyticsObject)) {
        var Sc = window.GoogleAnalyticsObject;
        Rc = Sc ? Sc.replace(/^[\s\xa0]+|[\s\xa0]+$/g, "") : ""
    }
    var gb = Rc || "ga",
        Ba = m,
        hb = T("apiVersion", "v"),
    ...
    function X(a, b, c, d) {
        b[a] = function () {
            try {
                ...
                var g = b && b[v];
                if (!(1 <= 100 * n.random())) {
                    var ca = ["t=error", "_e=exc", "_v=j7", "sr=1"];
                    a && ca[p]("_f=" + a);
    ...
    function fc() {
        ...
        b && (a = b[Ac](/[\d]+/g)) && 3 <= a[y] && (b = a[0] + "." + a[1] + " r" + a[2]);
        return b || ""
    };
    var gc = function (a, b) {
        ...
        mc = function (a) {
            if ("cookie" == P(a, ac)) {
                ...
                if (a) {
                    ...
                    b = b + "=" + a + "; path=" + g + "; ";
                    e && (b += "expires=" + (new Date((new Date)[Hc]() + e)).toGMTString() + "; ");
                    d && "none" != d && (b += "domain=" + d + ";");
                    d = M[r];
                    M.cookie = b;
                    b = d != M[r]
        ...
        Zc = function (a) {
            if (a.get(Xc)) {
                var b = P(a, W),
                    c = P(a, $b) || eb(),
                    d = Yc("__utma", c, b);
                d && (J(19), a.set(Tc, d.R), (b = Yc("__utmz", c, b)) && d[zc] == b[zc] && a.set(Uc, b.R))
            }
        },
        Gc = function (a, b, c) {
    ...
    function Yc(a, b, c) {
        ...
        return 0 == d[y] ? f : 1 == d[y] ? d[0] : $c(b, d) || $c(c, d) || $c(da, d) || d[0]
    }
    function $c(a, b) {
        var c, d;
        a == da ? c = d = 1 : (c = La(a), d = La(0 == a[t](".") ? a[F](1) : "." + a));
        for (var e = 0; e < b[y]; e++) if (b[e][zc] == c || b[e][zc] == d) return b[e]
    };
        ...
        function c(c) {
            try {
                ...
                a: {
                    ...
                    for (c = 100; ca && 0 < c;) {
                        if (ca[Nc] && ca.nodeName[Ac](/^a(?:rea)?$/i)) {
                            g = ca;
                            break a
                        }
                        ca = ca[Oc];
    ...
    var pc = function (a) {
        ...
        Jc = function (a, b) {
            if ("cookie" == P(a, ac)) {
                ...
                c || (c = P(a, W), d = P(a, $b) || eb(), c = Yc("__utma", d, c), (c = c == f ? f : c.O[1] + "." + c.O[2]) && J(10));
                c && (a[q].set(Q, c), hc = h)
            }
            if (e = (c = M[B][Nc][Ac]("(?:&|\\?)_ga=([^&]*)")) && 2 == c[y] ? c[1] : "") a.get(bc) ? (c = e[t]("."), -1 == c ? J(22) : (d = e[F](c + 1), "1" != e[F](0, c) ? J(22) : (c = d[t]("."), -1 == c ? J(22) : (e = d[F](0, c), c = d[F](c + 1), e != Ic(c, 0) && e != Ic(c, -1) && e != Ic(c, -2) ? J(23) : (J(11), a[q].set(Q, c)))))) : J(21);
            ...
            if (!a.get(Q)) {
                ...
                a[q].set(Q, [ra() ^ La(c) & 2147483647, n.round((new Date)[Hc]() / 1E3)][H]("."))
            }
            mc(a)
        },
        Kc = function (a) {
            ...
            d && a.set(kb, d[E] + "//" + d[ma] + d.pathname + d.search);
                    ...
                    if (!K(Z.k.get(d.a[0])) && !d.H && e) {
                        ...
                        if (s = l) {
                            ...
                            if (g.G || 0 <= g.url[t]("?") || 0 <= g.path[t]("://")) s = m;
                                ...
                                s = "www.google-analytics.com" == g[x] && (g[ja] || vb) == vb && 0 == g.path[t]("/plugins/") ? h : m
                            }
                        }
                        if (s) {
                            var g = d,
